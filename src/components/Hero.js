...
const Hero = () => {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('/new%20background%20image.jpg')" }}
    >
      {/* Dark Overlay */}
      ...
      <div className="container relative z-10 text-center px-4 sm:px-6 lg:px-8">
        <div className="mb-8 sm:mb-12">
          <h1 className="hero-title mb-6 sm:mb-8">
            <span className="block text-white drop-shadow-lg">Oluwaseun O.</span>
            <span className="block gradient-text drop-shadow-lg">Opebiyi</span>
          </h1>
        ...
        <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
          Certified Azure Cloud Practitioner | Cloud & DevOps Engineer
        </h2>
        
        <p className="text-lg sm:text-xl text-gray-200 mb-12 sm:mb-16 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
          Results-driven cloud professional with expertise in CI/CD, GitHub, Terraform, Kubernetes, 
          IaC, Linux, Python & Azure Infrastructure. Passionate about scalable cloud solutions.
        </p>
